...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_nds to login script."
...
# the current dir:
if   test x${GTLANG_nds} = x ; then
	echo "WARNING: The variable \${GTLANG_nds} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_nds} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_nds} has the value:"
	echo "  ${GTLANG_nds}"
