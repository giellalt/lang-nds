...
This directory contains source files for the Low German language
...
-   <https://giellalt.uit.no/lang/nds/index.xml> (analyser)
...
The Low German language sources can be acquired using [giella SVN
